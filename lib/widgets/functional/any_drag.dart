...
/// Recognizes movement.
///
/// In contrast to [MultiDragGestureRecognizer], [AnyDragGestureRecognizer]
...
///
/// [AnyDragGestureRecognizer] is not intended to be used directly. Instead,
/// consider using one of its subclasses to recognize specific types for drag
/// gestures.
///
/// [AnyDragGestureRecognizer] competes on pointer events of [kPrimaryButton]
...
///  * [AnyPanGestureRecognizer], for drags that are not locked to a single axis.
abstract class AnyDragGestureRecognizer extends OneSequenceGestureRecognizer {
  /// Initialize the object.
  ///
  /// [dragStartBehavior] must not be null.
  ///
  /// {@macro flutter.gestures.GestureRecognizer.kind}
  AnyDragGestureRecognizer({
    Object? debugOwner,
  ...
  ///
  /// To estimate the velocity of a gesture, [AnyDragGestureRecognizer] calls
...
class AnyPanGestureRecognizer extends AnyDragGestureRecognizer {
  /// Create a gesture recognizer for tracking movement on a plane.
  AnyPanGestureRecognizer({ Object? debugOwner }) : super(debugOwner: debugOwner);
